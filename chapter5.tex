...
Table \ref{tab:confusion_bearded} shows the confusion matrix for testing set of JAFFE dataset which contains 20\% of the whole JAFFE dataset.
\begin{table}[H]
    \centering
...
Another performance measuring curve, \emph{Receiver Operating Curve (ROC) curve} is shown in figure \ref{fig:roc_curve_brearded}.
...
Following figure \ref{fig:precision_curve_bearded} shows the \emph{Precision, Recall and F-Score Curve} for the testing set of JAFFE dataset.
\begin{figure}[H]
    \centering
    \includegraphics[width=6in,height=5in]{images/chapter5/bearded82_extension_precision_recall.png}
    \caption{Precision, Recall Curve for JAFFE dataset}
