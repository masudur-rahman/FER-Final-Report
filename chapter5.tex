...
\caption{Visualizing the Confusion Matrix}
 \begin{tabular}{|c|c|c|} 
 \hline
 \backslashbox{Actual}{Predicted} & Class = Yes & Class = No\\
 \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        \hline
        \backslashbox{In}{Out} & Neutral & Happy & Sadness & Anger & Surprise & Fear & Disgust \\
        \hline
...
\begin{figure}[H]
    \centering
    \includegraphics[width=6in,height=4.9in]{images/chapter5/bearded82_extension_precision_recall.png}
